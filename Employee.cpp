...
void Employee::display()
 {
     ...
     cout << "Age: " << getEmployeeAge() << endl;
     cout << "Code: " << getEmployeeCode() << endl;
     cout << "Gender: " << genderToString() << endl;
     cout << "Address: " << getEmployeeAddress() << endl;
     cout << "Passport: " << getEmployeePassport() << endl;
     cout << "Salary: " << getEmployeeSalary() << endl;
     cout << "Position: " << positionToString() << endl;
     cout << "-------------------------" << endl;
     cout << endl;
 }
